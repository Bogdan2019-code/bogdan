var VPlayer = (function() {
  ...
  s1.addEventListener('click', function(e){
    ...
    video.pause();
    videosrc.setAttribute('src', 'https://app.nihaocloud.com/f/a13b524b13394bd89629/?raw=1');
    video.load();
    video.play();
  ...
  s2.addEventListener('click', function(e){
    ...
    video.pause();
    videosrc.setAttribute('src', 'https://app.nihaocloud.com/f/862560c351e64f4a8a46/?raw=1');
    video.load();
    video.play();
    playButton.classList.remove('paused');
    playButton.classList.add('playing');
  ...
  s3.addEventListener('click', function(e){
    ...
    video.pause();
    videosrc.setAttribute('src', 'https://app.nihaocloud.com/f/7ee43ee8aba347d9b815/?raw=1');
    video.load();
    video.play();
    playButton.classList.remove('paused');
    playButton.classList.add('playing');
