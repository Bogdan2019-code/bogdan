var VPlayer = (function() {
  ...
  s1.addEventListener('click', function(e){
    ...
    video.pause();
    videosrc.setAttribute('src', 'https://sakuramao.cn/video/stream1.mp4');
    video.load();
    video.play();
  ...
  s2.addEventListener('click', function(e){
    ...
    video.pause();
    videosrc.setAttribute('src', 'https://sakuramao.cn/video/stream2.mp4');
    video.load();
    video.play();
    playButton.classList.remove('paused');
    playButton.classList.add('playing');
  ...
  s3.addEventListener('click', function(e){
    ...
    video.pause();
    videosrc.setAttribute('src', 'https://sakuramao.cn/video/stream3.mp4');
    video.load();
    video.play();
    playButton.classList.remove('paused');
    playButton.classList.add('playing');
