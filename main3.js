var VPlayer = (function() {
  ...
  s1.addEventListener('click', function(e){
    ...
    video.pause();
    videosrc.setAttribute('src', 'https://app.nihaoconsult.cn/f/5195e42570274641905f/?raw=1');
    video.load();
    video.play();
  ...
  s2.addEventListener('click', function(e){
    ...
    video.pause();
    videosrc.setAttribute('src', 'https://app.nihaoconsult.cn/f/5190d978c8dd47cba796/?raw=1');
    video.load();
    video.play();
    playButton.classList.remove('paused');
    playButton.classList.add('playing');
  ...
  s3.addEventListener('click', function(e){
    ...
    video.pause();
    videosrc.setAttribute('src', 'https://app.nihaoconsult.cn/f/e8da5e850f8242daa3c9/?raw=1');
    video.load();
    video.play();
    playButton.classList.remove('paused');
    playButton.classList.add('playing');
